...
void init_dstc()
{
	...
	stcDES[0].DES1_mode1.ORM = ((c_block_size -1) >> 8) + 1;			// outer loop count
	stcDES[0].DES1_mode1.IIN = (stcDES[0].DES1_mode1.ORM > 1) ? 0 : c_block_size & 0XFF;  // Inner loop, max 256; 256 = 0
	...
	stcDES[1].DES1_mode1.ORM = ((c_block_size -1) >> 8) + 1;		// outer loop count
	stcDES[1].DES1_mode1.IIN = (stcDES[1].DES1_mode1.ORM > 1) ? 0 : c_block_size & 0XFF;  // Inner loop, max 256; 256 = 0
